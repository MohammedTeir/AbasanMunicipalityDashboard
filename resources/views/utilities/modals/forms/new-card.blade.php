...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="card-px text-center pt-15 pb-15">
            ...
            <!--begin::Action-->
            <a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_new_card">
                Add New Card            </a>
            <!--end::Action-->
        </div>
        <!--end::Heading-->
...
<!--end::Modal - Invite Friend--><!--begin::Modal - New Card-->
...
<!--end::Modal - New Card--><!--begin::Modal - Users Search-->
