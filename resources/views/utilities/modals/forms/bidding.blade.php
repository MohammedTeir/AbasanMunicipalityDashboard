    ...
    <div class="card-body">
        ...
        <div class="card-px text-center pt-15 pb-15">
            ...
            <p class="text-gray-400 fs-4 fw-semibold py-7">
                Click on the below buttons to launch <br>a bidding modal example.            </p>
            <!--end::Description-->
...
<!--end::Svg Icon-->        <!--end::Icon-->
    ...
    <div class="d-flex flex-stack flex-grow-1 ">
            ...
            <div class=" fw-semibold">
                                    ...
                                    <div class="fs-6 text-gray-700 "> Not enough funds in your wallet? <a href="../wizards/top-up-wallet.html" class="text-bolder">Top up wallet</a>.</div>
                            </div>
            <!--end::Content-->
