    ...
    <div class="card-body">
        ...
        <div class="card-px text-center pt-15 pb-15">
            ...
            <p class="text-gray-400 fs-4 fw-semibold py-7">
                Click on the below buttons to launch <br>a share & earn example.            </p>
            <!--end::Description-->

            <!--begin::Action-->
            <a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_share_earn">
                Share & Earn            </a>
            <!--end::Action-->
        </div>
        <!--end::Heading-->
...
<!--end::Modal - Invite Friend--><!--begin::Modal - Share & Earn-->
                ...
                <div class="mw-lg-600px mx-auto">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="#" class="btn btn-light w-100 mx-6">
                            <img alt="Logo" src="../../../assets/media/svg/social-logos/facebook.svg" class="h-20px me-3">   
                            Facebook
                        </a>

                        <a href="#" class="btn btn-light w-100">
                            <img alt="Logo" src="../../../assets/media/svg/social-logos/twitter.svg" class="h-20px me-3">   
                            Twitter
                        </a>
                    </div>
                    <!--end::Actions-->
...
<!--end::Modal - Share & Earn--><!--begin::Modal - Users Search-->
