    ...
    <div class="card-body">
        ...
        <div class="card-px text-center pt-15 pb-15">
            ...
            <p class="text-gray-400 fs-4 fw-semibold py-7">
                Click on the below buttons to launch <br>a deal offer agreement flow example.            </p>
            <!--end::Description-->

            <!--begin::Action-->
            <a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_offer_a_deal">
                Offer a Deal            </a>
            <!--end::Action-->
        </div>
        <!--end::Heading-->
        ...
        <div class="text-center pb-15 px-5">
            <img src="../../assets/media/illustrations/sketchy-1/7.png" alt="" class="mw-100 h-200px h-sm-325px">          
        </div>
        <!--end::Illustration-->
    </div>
    <!--end::Card body-->
...
<!--end::Modal - Invite Friend--><!--begin::Modal - Offer A Deal-->
