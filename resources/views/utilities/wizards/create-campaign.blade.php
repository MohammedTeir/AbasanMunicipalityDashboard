    ...
    <div class="card-body">
        ...
        <div class="card-px text-center pt-15 pb-15">
            ...
            <p class="text-gray-400 fs-4 fw-semibold py-7">
                Click on the below buttons to launch <br>create campaign modal example.            </p>
            <!--end::Description-->

            <!--begin::Action-->
            <a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign">
                Create Campaign            </a>
            <!--end::Action-->
        </div>
        <!--end::Heading-->
...
<div data-kt-stepper-element="content">
    ...
    <div class="w-100">
        ...
        <div class="fv-row mb-10">
            ...
            <!--begin::Tagify-->
            <input class="form-control d-flex align-items-center" value="" id="kt_modal_create_campaign_location" data-kt-flags-path="/metronic8/demo8/assets/media/flags/">
            <!--end::Tagify-->
        </div>
        <!--end::Input group-->
