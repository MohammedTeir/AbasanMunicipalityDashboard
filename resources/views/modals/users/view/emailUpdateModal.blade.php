        ...
        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
          ...
          <form id="kt_modal_update_email_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
            ...
            <div class="fv-row mb-7 fv-plugins-icon-container">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <input class="form-control form-control-solid" placeholder="new email" name="profile_email" id="profile_email" value="{{$user->email}}">
              <!--end::Input-->
            ...
            <div class="text-center pt-15">
              ...
              <button type="button" class="btn btn-primary" onclick="performUpdateEmail({{$user->id}})">
