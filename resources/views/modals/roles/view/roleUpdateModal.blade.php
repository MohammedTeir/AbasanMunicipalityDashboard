        ...
        <div class="modal-content">
                ...
                <form id="kt_modal_update_role_form"
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7"
                        ...
                        <div class="fv-row mb-10 fv-plugins-icon-container">
                            ...
                            <!--begin::Input-->
                            <input class="form-control form-control-solid" placeholder="Enter a role name" value="{{$role->name}}" id="role_name_edit">
                            <!--end::Input-->
            ...
            <!--end::Input group-->
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <label class="form-check form-check-sm form-check-custom form-check-solid me-5 me-lg-20">
                                                            <input class="form-check-input" type="checkbox"  value="{{ $permission->name }}" id="permissions[]" name="permissions[]" {{$role->hasPermissionTo($permission)?'checked':''}}>
                                                        </label>
                                                        <!--end::Checkbox-->
                                                    </div>
                                                    <!--end::Wrapper-->
                    ...
                    <div class="text-center pt-15">
                        ...
                        <button type="button" class="btn btn-primary" id="update-button" onclick="performUpdate()">
