...
<!--end::Svg Icon-->                <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Subscriptions">
            </div>
            <!--end::Search-->
        </div>
        <!--begin::Card title-->
...
<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
    ...
    <tbody class="text-gray-600 fw-semibold">
                ...
                <!--begin::Customer--->
                <td>
                    <a href="../customers/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
                </td>
                <!--end::Customer--->
...
<!--end::Menu-->
                ...
                <!--begin::Customer--->
                <td>
                    <a href="../customers/view.html" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
                </td>
                <!--end::Customer--->
...
<!--end::Menu-->
                ...
                <!--begin::Customer--->
                <td>
                    <a href="../customers/view.html" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
                </td>
                <!--end::Customer--->
...
<!--end::Menu-->
                ...
                <!--begin::Customer--->
                <td>
                    <a href="../customers/view.html" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
                </td>
                <!--end::Customer--->
...
<!--end::Menu-->
                ...
                <!--begin::Customer--->
                <td>
                    <a href="../customers/view.html" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
                </td>
                <!--end::Customer--->
...
<!--end::Menu-->
                ...
                <!--begin::Customer--->
                <td>
                    <a href="../customers/view.html" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
                </td>
                <!--end::Customer--->
...
<!--end::Menu-->
                ...
                <!--begin::Customer--->
                <td>
                    <a href="../customers/view.html" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
                </td>
                <!--end::Customer--->
...
<!--end::Menu-->
                ...
                <!--begin::Customer--->
                <td>
                    <a href="../customers/view.html" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
                </td>
                <!--end::Customer--->
...
<!--end::Menu-->
                ...
                <!--begin::Customer--->
                <td>
                    <a href="../customers/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
                </td>
                <!--end::Customer--->
...
<!--end::Menu-->
                ...
                <!--begin::Customer--->
                <td>
                    <a href="../customers/view.html" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
                </td>
                <!--end::Customer--->
...
<!--end::Menu-->
                ...
                <!--begin::Customer--->
                <td>
                    <a href="../customers/view.html" class="text-gray-800 text-hover-primary mb-1">Robert Doe</a>
                </td>
                <!--end::Customer--->
...
<!--end::Menu-->
                ...
                <!--begin::Customer--->
                <td>
                    <a href="../customers/view.html" class="text-gray-800 text-hover-primary mb-1">John Miller</a>
                </td>
                <!--end::Customer--->
...
<!--end::Menu-->
                ...
                <!--begin::Customer--->
                <td>
                    <a href="../customers/view.html" class="text-gray-800 text-hover-primary mb-1">Lucy Kunic</a>
                </td>
                <!--end::Customer--->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form id="kt_subscriptions_export_form" class="form" action="#">
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <!--begin::Input-->
                        <select name="format" data-control="select2" data-placeholder="Select a format" data-hide-search="true" name="format" class="form-select form-select-solid">
