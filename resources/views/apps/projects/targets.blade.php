...
<!--end::Svg Icon-->                                <div class="fs-4 fw-bold" data-kt-countup="true" data-kt-countup-value="15000" data-kt-countup-prefix="$">0</div>
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            <!--begin::Nav item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary py-5 me-6 " href="project.html">
                        Overview                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary py-5 me-6 active" href="targets.html">
                        Targets                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
...
<span class="svg-icon svg-icon-1"><svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewbox="0 0 24 24">
...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_63f617f5ea9b7">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_63f617f5ea9b7" data-allow-clear="true">
                    <option></option>
...
<!--end::Svg Icon-->                    <span class="ms-1 fs-7 fw-bold text-gray-600">9</span>
                </div>
                <!--end::Stat-->
            </div>
            <!--end::Stats-->
...
<!--end::Svg Icon-->                    <span class="ms-1 fs-7 fw-bold text-gray-600">7</span>
                </div>
                <!--end::Stat-->
            </div>
            <!--end::Stats-->
...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_63f617f5eaaaf">
    <!--begin::Header-->
    <div class="px-7 py-5">
        <div class="fs-5 text-dark fw-bold">Filter Options</div>
    </div>
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_63f617f5eaaaf" data-allow-clear="true">
                    <option></option>
                    <option value="1">Approved</option>
                    <option value="2">Pending</option>
                    <option value="2">In Process</option>
...
<!--end::Svg Icon-->                    <span class="ms-1 fs-7 fw-bold text-gray-600">10</span>
                </div>
                <!--end::Stat-->
...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_63f617f5eac2e">
    <!--begin::Header-->
    <div class="px-7 py-5">
        <div class="fs-5 text-dark fw-bold">Filter Options</div>
    </div>
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_63f617f5eac2e" data-allow-clear="true">
                    <option></option>
                    <option value="1">Approved</option>
                    <option value="2">Pending</option>
                    <option value="2">In Process</option>
...
<!--end::Svg Icon-->                    <span class="ms-1 fs-7 fw-bold text-gray-600">6</span>
                </div>
                <!--end::Stat-->
...
<!--end::Svg Icon-->                    <span class="ms-1 fs-7 fw-bold text-gray-600">8</span>
                </div>
                <!--end::Stat-->
            </div>
            <!--end::Stats-->
    ...
    <div class="card-body pt-3">
        ...
        <table id="kt_profile_overview_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bold">
            ...
            <tbody class="fs-6">
                                    <!--begin::Table row-->
                    <tr>
                        <td class="fw-bold"><a href="#" class="text-gray-900 text-hover-primary">Meeting with customer</a></td>

                        <td><span class="badge badge-light fw-semibold me-auto">UI Design</span></td>
                        ...
                        <td><span class="badge badge-light-primary fw-bold me-auto">In Progress</span></td>
                    ...
                    <!--end::Table row-->
                                    <!--begin::Table row-->
                    <tr>
                        <td class="fw-bold"><a href="#" class="text-gray-900 text-hover-primary">User Module Testing</a></td>

                        <td><span class="badge badge-light fw-semibold me-auto">Phase 2.6 QA</span></td>
                        ...
                        <td><span class="badge badge-light-success fw-bold me-auto">Completed</span></td>
                    ...
                    <!--end::Table row-->
                                    <!--begin::Table row-->
                    <tr>
                        <td class="fw-bold"><a href="#" class="text-gray-900 text-hover-primary">Sales report page</a></td>

                        <td><span class="badge badge-light fw-semibold me-auto">QA</span></td>
                        ...
                        <td><span class="badge badge-light fw-bold me-auto">Yet to start</span></td>
                    ...
                    <tr>
                        ...
                        <td><span class="badge badge-light fw-semibold me-auto">Prototype</span></td>
                    ...
                    <!--end::Table row-->
                                    <!--begin::Table row-->
                    <tr>
                        <td class="fw-bold"><a href="#" class="text-gray-900 text-hover-primary">Design main Dashboard</a></td>
                    ...
                    <tr>
                        ...
                        <td><span class="badge badge-light fw-semibold me-auto">Development</span></td>
                    ...
                    <!--end::Table row-->
                                    <!--begin::Table row-->
                    <tr>
                        <td class="fw-bold"><a href="#" class="text-gray-900 text-hover-primary">To check User Management</a></td>

                        <td><span class="badge badge-light fw-semibold me-auto">Pahse 3.2</span></td>
                    ...
                    <!--end::Table row-->
                                    <!--begin::Table row-->
                    <tr>
                        <td class="fw-bold"><a href="#" class="text-gray-900 text-hover-primary">Create Roles Module</a></td>

                        <td><span class="badge badge-light fw-semibold me-auto">Branding</span></td>
