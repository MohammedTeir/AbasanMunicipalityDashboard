...
<div class="content d-flex flex-column flex-column-fluid " id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
      ...
      <div id="kt_content_container" class=" container-xxl ">
          ...
          <div class="flex-column flex-lg-row-auto w-lg-250px w-xl-350px mb-10">
            ...
            <div class="card-body">
                ...
                <div class="d-flex flex-center flex-column py-5">
                  ...
                  <div class="mb-9">
                    <!--begin::Badge-->
                    <div class="badge-light-primary d-inline"> {!! html_entity_decode($user->role->role_badge ?? '' ) !!}</div>
                    <!--begin::Badge-->
                  </div>
                  <!--end::Position-->
                </div>
                ...
                <div class="d-flex flex-stack fs-4 py-3">
                  <div class="fw-bold rotate collapsible collapsed" data-bs-toggle="collapse" href="#kt_user_view_details" role="button" aria-expanded="false" aria-controls="kt_user_view_details"> Details <span class="ms-2 rotate-180">
                ...
                <div id="kt_user_view_details" class="collapse" style="">
                  <div class="pb-5 fs-6">
                    ...
                    <div class="text-gray-600">ID-{{$user->pin}}</div>
                    <!--begin::Details item-->
                    <!--begin::Details item-->
                    ...
                    <div class="text-gray-600">{{$user->last_login_format}}</div>
                    <!--begin::Details item-->
                  </div>
                </div>
                <!--end::Details content-->
            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8" role="tablist">
              ...
              <li class="nav-item ms-auto">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold py-4 w-250px fs-6" data-kt-menu="true" style="">
                  ...
                  <div class="menu-item px-5">
                    @if (!$user->trashed())
                    <a class="menu-link text-danger px-5" onclick="performDelete({{ $user->id }}, this)"> Delete user </a>
                    @else
                    <a class="menu-link text-success px-5" onclick="performRestore({{ $user->id }}, this)"> Restore user </a>
                    @endif
                  </div>
                  <!--end::Menu item-->
                  @endcan
       ...
       @include('modals.users.view.detailsUpdateModal')
        <!--end::Modal - Update user details-->

        <!--begin::Modal - Update email-->
        @include('modals.users.view.emailUpdateModal')
        <!--end::Modal - Update email-->
        <!--begin::Modal - Update password-->
        @include('modals.users.view.passwordUpdateModal')
        <!--end::Modal - Update password-->
        <!--begin::Modal - Update role-->
        {{-- @include('modals.users.view.roleUpdateModal') --}}
...
function performUpdateDetails(id) {
    ...
    putRequest('/dashboard/users/'+id,data,'/dashboard/users/'+id);
}
...
<script>
    ...
    formData.append('avatar', document.getElementById('avatar').files[0]);
        ...
        axios.post(`/dashboard/users/${id}/avatar`, formData)
        .then(function (response) {
            ...
            putRequest(`/dashboard/users/${id}/email`,data,'/dashboard/users/'+id);
        ...
        function performUpdatePassword(id) {
            ...
            putRequest(`/dashboard/users/${id}/password/`,data,'/dashboard/users/'+id);
        }

        // function performUpdateRole(id) {
        //     let selectedRadio = document.querySelector('input[id="user_role"]:checked');
        //     let data = {
        //         'role':selectedRadio.value
        //     };

        //     putRequest(`/dashboard/users/${id}/role/`,data,'/dashboard/users/'+id);
        // }
...
<script>
    function performDelete(id,reference) {
                confirmDeleteRequest('/dashboard/users/'+id,reference,'/dashboard/users/'+id);
            }

    function performRestore(id,reference) {
                putRequest(`/dashboard/users/${id}/restore/`,reference,'/dashboard/users/'+id);
            }
    </script>
...
<!--begin::Custom Javascript(used for this page only)-->
     <script src="{{asset('assets/js/custom/apps/human-resource/users/view/view.js')}}"></script>
     <script src="{{asset('assets/js/custom/apps/human-resource/users/view/update-details.js')}}"></script>
     <script src="{{asset('assets/js/custom/apps/human-resource/users/view/update-email.js')}}"></script>
     <script src="{{asset('assets/js/custom/apps/human-resource/users/view/update-password.js')}}"></script>
     <script src="{{asset('assets/js/custom/apps/human-resource/users/view/update-role.js')}}"></script>
