...
<!--end::Svg Icon--></span><span class="menu-title">Widgets</span><span class="menu-arrow"></span></span><!--end:Menu link--><!--begin:Menu sub--><div class="menu-sub menu-sub-accordion"><!--begin:Menu item--><div class="menu-item"><!--begin:Menu link--><a class="menu-link" href="lists.html"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Lists</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div class="menu-item"><!--begin:Menu link--><a class="menu-link" href="statistics.html"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Statistics</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div class="menu-item"><!--begin:Menu link--><a class="menu-link" href="charts.html"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Charts</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div class="menu-item"><!--begin:Menu link--><a class="menu-link" href="mixed.html"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Mixed</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div class="menu-item"><!--begin:Menu link--><a class="menu-link active" href="tables.html"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Tables</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div class="menu-item"><!--begin:Menu link--><a class="menu-link" href="feeds.html"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Feeds</span></a><!--end:Menu link--></div><!--end:Menu item--></div><!--end:Menu sub--></div><!--end:Menu item--><!--begin:Menu item--><div class="menu-item pt-5"><!--begin:Menu content--><div class="menu-content"><span class="menu-heading fw-bold text-uppercase fs-7">Apps</span></div><!--end:Menu content--></div><!--end:Menu item--><!--begin:Menu item--><div data-kt-menu-trigger="click" class="menu-item menu-accordion"><!--begin:Menu link--><span class="menu-link"><span class="menu-icon"><!--begin::Svg Icon | path: icons/duotune/abstract/abs042.svg-->
<span class="svg-icon svg-icon-2"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_63f617f30a6d5">
    <!--begin::Header-->
    <div class="px-7 py-5">
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_63f617f30a6d5" data-allow-clear="true">
                    <option></option>
...
<!--begin::Menu 1-->
<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_63f617f30a75a">
    <!--begin::Header-->
    <div class="px-7 py-5">
        <div class="fs-5 text-dark fw-bold">Filter Options</div>
    </div>
    ...
    <div class="px-7 py-5">
        ...
        <div class="mb-10">
            ...
            <!--begin::Input-->
            <div>
                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_63f617f30a75a" data-allow-clear="true">
                    <option></option>
                    <option value="1">Approved</option>
                    <option value="2">Pending</option>
                    <option value="2">In Process</option>
...
<span class="svg-icon svg-icon-2x svg-icon-info"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <td>
                                <div class="symbol symbol-50px me-2">
                                    <span class="symbol-label bg-light-warning">
                                        <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
<span class="svg-icon svg-icon-2x svg-icon-warning"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path opacity="0.3" d="M21.25 18.525L13.05 21.825C12.35 22.125 11.65 22.125 10.95 21.825L2.75 18.525C1.75 18.125 1.75 16.725 2.75 16.325L4.04999 15.825L10.25 18.325C10.85 18.525 11.45 18.625 12.05 18.625C12.65 18.625 13.25 18.525 13.85 18.325L20.05 15.825L21.35 16.325C22.35 16.725 22.35 18.125 21.25 18.525ZM13.05 16.425L21.25 13.125C22.25 12.725 22.25 11.325 21.25 10.925L13.05 7.62502C12.35 7.32502 11.65 7.32502 10.95 7.62502L2.75 10.925C1.75 11.325 1.75 12.725 2.75 13.125L10.95 16.425C11.65 16.725 12.45 16.725 13.05 16.425Z" fill="currentColor"></path>
<path d="M11.05 11.025L2.84998 7.725C1.84998 7.325 1.84998 5.925 2.84998 5.525L11.05 2.225C11.75 1.925 12.45 1.925 13.15 2.225L21.35 5.525C22.35 5.925 22.35 7.325 21.35 7.725L13.05 11.025C12.45 11.325 11.65 11.325 11.05 11.025Z" fill="currentColor"></path>
</svg>
</span>
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td>
                                            <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Media Device</a>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <span class="text-dark fw-bold d-block fs-7">5 day ago</span>
                                        </td>
                                        <td class="text-end">
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td>
                                            <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Special Meal</a>
                                            <span class="text-muted fw-semibold d-block fs-7">Quona Rice</span>
                                        </td>
                                        <td class="text-end">
                                            <span class="text-muted fw-semibold d-block fs-8">Ordered</span>
                                            
                                            <span class="text-dark fw-bold d-block fs-7">2 day ago</span>
                                        </td>
                                        <td class="text-end">
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <span class="text-dark fw-bold d-block fs-7">4 day ago</span>
                                        </td>
                                        <td class="text-end">
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <span class="text-dark fw-bold d-block fs-7">1 day ago</span>
                                        </td>
                                        <td class="text-end">
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td>
                                            <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Strawberry Boxes</a>
                                            <span class="text-muted fw-semibold d-block fs-7">From Spain</span>
                                        </td>
                                        <td class="text-end">
                                            <span class="text-muted fw-semibold d-block fs-8">Ordered</span>
                                            
                                            <span class="text-dark fw-bold d-block fs-7">7 day ago</span>
                                        </td>
                                        <td class="text-end">
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <span class="text-dark fw-bold d-block fs-7">4 week ago</span>
                                        </td>
                                        <td class="text-end">
                                            <span class="badge badge-light-info fs-7 fw-bold">Delivered</span>
                                        </td>
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <span class="text-dark fw-bold d-block fs-7">2 week ago</span>
                                        </td>
                                        <td class="text-end">
                                            <span class="badge badge-light-danger fs-7 fw-bold">Delivered</span>
                                        </td>
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <span class="text-dark fw-bold d-block fs-7">5 week ago</span>
                                        </td>
                                        <td class="text-end">
                                            <span class="badge badge-light-warning fs-7 fw-bold">Delivered</span>
                                        </td>
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <span class="text-dark fw-bold d-block fs-7">3 month ago</span>
                                        </td>
                                        <td class="text-end">
                                            <span class="badge badge-light-success fs-7 fw-bold">Delivered</span>
                                        </td>
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <span class="text-dark fw-bold d-block fs-7">5 month ago</span>
                                        </td>
                                        <td class="text-end">
                                            <span class="badge badge-light-danger fs-7 fw-bold">Delivered</span>
                                        </td>
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <span class="text-dark fw-bold d-block fs-7">6 month ago</span>
                                        </td>
                                        <td class="text-end">
                                            <span class="badge badge-light-warning fs-7 fw-bold">Delivered</span>
                                        </td>
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <span class="text-dark fw-bold d-block fs-7">4 month ago</span>
                                        </td>
                                        <td class="text-end">
                                            <span class="badge badge-light-info fs-7 fw-bold">Delivered</span>
                                        </td>
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td>
                                            <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">School Music Festival</a>
                                            <span class="text-muted fw-semibold d-block fs-7">by Rose Liam</span>
                                        </td>   
                                        <td class="text-end">
                                            <span class="text-dark fw-bold d-block fs-7">4:20PM, 03 Sep</span>
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td>
                                            <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Maths Championship</a>
                                            <span class="text-muted fw-semibold d-block fs-7">By Tom Gere</span>
                                        </td>   
                                        <td class="text-end">
                                            <span class="text-dark fw-bold d-block fs-7">10:05PM, 25 Oct</span>
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td>
                                            <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Who Knows Geography</a>
                                            <span class="text-muted fw-semibold d-block fs-7">By Zoey Dylan</span>
                                        </td>   
                                        <td class="text-end">
                                            <span class="text-dark fw-bold d-block fs-7">3:22PM, 07 Sep</span>
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td>
                                            <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Napoleon Days</a>
                                            <span class="text-muted fw-semibold d-block fs-7">By Luke Owen</span>
                                        </td>   
                                        <td class="text-end">
                                            <span class="text-dark fw-bold d-block fs-7">1:20PM, 02 Dec</span>
...
<!--end::Svg Icon-->                                                </span>
                                        ...
                                        <td>
                                            <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">The School Art Leads</a>
                                            <span class="text-muted fw-semibold d-block fs-7">By Ellie Cole</span>
                                        </td>   
                                        <td class="text-end">
                                            <span class="text-dark fw-bold d-block fs-7">6:20PM, 07 Sep</span>
