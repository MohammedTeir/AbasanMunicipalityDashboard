...
<!--end::Svg Icon--> 
                ...
                <a href="promo-2.html" class="btn btn-icon flex-column btn-text-gray-500 btn-icon-gray-300 btn-active-text-gray-700 btn-active-icon-gray-500 rounded-3 h-60px w-60px h-lg-90px w-lg-90px fw-semibold active bg-light border border-2">
            ...
            <a href="promo-2-1.html?nav=0" class="flex-grow-1 text-end mt-2">
...
<!--end::Svg Icon--> 
    ...
    <div style="margin-bottom:55px; text-align:left">
        ...
        <div style="margin:0 60px 38px 60px">
            <img alt="" style="width:100%" src="../../assets/media/email/img-2.png"> 
        </div>     
        <!--end:Media-->  
