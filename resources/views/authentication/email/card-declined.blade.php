...
<!--end::Svg Icon--> 
                ...
                <a href="card-declined.html" class="btn btn-icon flex-column btn-text-gray-500 btn-icon-gray-300 btn-active-text-gray-700 btn-active-icon-gray-500 rounded-3 h-60px w-60px h-lg-90px w-lg-90px fw-semibold active bg-light border border-2">
            ...
            <a href="card-declined-1.html?nav=0" class="flex-grow-1 text-end mt-2">
...
<!--end::Svg Icon--> 
    ...
    <div style="text-align:center; margin:0 60px 34px 60px">
        ...
        <div style="text-align:start; font-size: 13px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
            ...
            <p style="margin-bottom:2px; color:#5E6278">Feel free to call our customer care number:<span style="color:#50cd89; font-weight: 600">+31 6 3344 55 56</span>    
            <p style="margin-bottom:2px; color:#5E6278">You may reach us at <a href="https://devs.keenthemes.com" target="_blank" style="color:#50cd89; font-weight: 600">devs.keenthemes.com</a></p>      
        </div>  
        <!--end:Text-->   
        
        <!--begin:Action-->
        <a href="../../pages/contact.html" target="_blank" style="position: relative;
    left: 50%;
    transform: translateX(-50%);background-color:#50cd89; border-radius:6px; display:inline-block; margin-top:27px; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500;font-family:Arial,Helvetica,sans-serif;">
            Contact Us Now
        </a>      
        <!--end:Action-->   
    </div>
