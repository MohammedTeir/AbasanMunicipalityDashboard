...
<!--end::Svg Icon--> 
                ...
                <a href="promo-1.html" class="btn btn-icon flex-column btn-text-gray-500 btn-icon-gray-300 btn-active-text-gray-700 btn-active-icon-gray-500 rounded-3 h-60px w-60px h-lg-90px w-lg-90px fw-semibold active bg-light border border-2">
            ...
            <a href="promo-1-1.html?nav=0" class="flex-grow-1 text-end mt-2">
...
<!--end::Svg Icon--> 
    ...
    <div style="text-align:left; margin-bottom:54px">
        ...
        <div style="font-size: 14px; font-weight: 500; margin:0 60px 30px 60px; font-family:Arial,Helvetica,sans-serif">
            <p style="color:#181C32; font-size: 28px; font-weight:700; line-height:1.4; margin-bottom:24px">
                Create paragraphs:<br>
                You have bundled topics togetherin the text structure you have set up
            </p>
            
            <p style="margin-bottom:2px; color:#3F4254; line-height:1.6">
                Lots of people make mistakes while creating paragraphs. 
                Some writers just put whitespace in their text in random places 
                for aesthetic purposes but don’t think about the coherence and 
                structure of the text. In many cases, the coherence within paragraphs 
                and between paragraphs remains unclear. These kinds of mistakes 
                can mess up the structure of your articles.
            </p>              
        </div>  
        <!--end:Text--> 

        <!--begin:Action-->
        <a href="../../pages/blog/post.html" target="_blank" style="background-color:#50cd89; margin-bottom: 70px; border-radius:6px;display:inline-block; margin-left:60px; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif;">
            Read Blog
        </a> 
        <!--end:Action-->  
        ...
        <div style="margin-bottom: 57px;">
            <img alt="" style="width:100%" src="../../assets/media/email/img-1.png"> 
        </div>     
        <!--end:Media-->  
        
        <!--begin:Text-->
        <div style="font-size: 14px; font-weight: 500; margin:0 60px 33px 60px; font-family:Arial,Helvetica,sans-serif">
            <p style="color:#181C32; font-size: 28px; font-weight:700; margin-bottom:24px">
                Understand your audience
            </p>

            <p style="margin-bottom:24px; color:#3F4254; line-height:1.6">
                Before you start writing your blog post, make sure you have a clear <br> 
                understanding of your <a href="#">target audience.</a>
            </p>     
            ...
            <p style="color:#3F4254; line-height:1.6">
                For instance, if your readers are millennials looking to start a business, 
                you probably don't need to provide them with information about getting started 
        ...
        <!--begin:Action-->
        <a href="../../pages/blog/post.html" target="_blank" style="background-color:#50cd89; border-radius:6px; display:inline-block; margin-left:60px; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500; font-family:Arial,Helvetica,sans-serif;">
            Read Blog
        </a> 
        <!--end:Action-->        
    </div>
    <!--end:Email content-->    
                            ...
                            <tr style="display: flex; justify-content: center; margin:0 60px 35px 60px">
                                <td align="start" valign="start" style="padding-bottom: 10px;">
                                    <p style="color:#181C32; font-size: 18px; font-weight: 600; margin-bottom:13px">Promo FAQ</p>
