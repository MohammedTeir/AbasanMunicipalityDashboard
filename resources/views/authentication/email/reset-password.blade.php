...
<!--end::Svg Icon--> 
                ...
                <a href="reset-password.html" class="btn btn-icon flex-column btn-text-gray-500 btn-icon-gray-300 btn-active-text-gray-700 btn-active-icon-gray-500 rounded-3 h-60px w-60px h-lg-90px w-lg-90px fw-semibold active bg-light border border-2">
            ...
            <a href="reset-password-1.html?nav=0" class="flex-grow-1 text-end mt-2">
