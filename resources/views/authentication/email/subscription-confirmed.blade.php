...
<!--end::Svg Icon--> 
                ...
                <a href="subscription-confirmed.html" class="btn btn-icon flex-column btn-text-gray-500 btn-icon-gray-300 btn-active-text-gray-700 btn-active-icon-gray-500 rounded-3 h-60px w-60px h-lg-90px w-lg-90px fw-semibold active bg-light border border-2">
            ...
            <a href="subscription-confirmed-1.html?nav=0" class="flex-grow-1 text-end mt-2">
...
<!--end::Svg Icon--> 
    ...
    <div style="text-align:center; margin:0 60px 34px 60px">
        ...
        <!--begin:Action-->
        <a href="../../apps/invoices/view/invoice-1.html" target="_blank" style="background-color:#50cd89; border-radius:6px;display:inline-block; padding:11px 19px; color: #FFFFFF; font-size: 14px; font-weight:500;">
            Download Invoice
        </a>
        <!--begin:Action-->         
    </div>
