...
@section('content')
    <!--begin::Body-->
    <form class="d-flex align-items-center" id="kt_sign_in_form" novalidate="novalidate">
        <div class="card-body">
            <!--begin::Heading-->
            ...
            <div class="fv-row mb-8">
                ...
                <input type="email" placeholder="Email" name="email" autocomplete="on"
                    data-kt-translate="sign-in-input-email" class="form-control form-control-solid" id="email">
                <!--end::Email-->
            </div>
            ...
            <div class="fv-row mb-7">
                ...
                <input type="password" placeholder="Password" name="password" autocomplete="on"
                    data-kt-translate="sign-in-input-password" class="form-control form-control-solid" id="password">
                <!--end::Password-->
            </div>
            <!--end::Input group--->
            ...
            <div class="d-flex flex-stack">
                <!--begin::Submit-->
                <button type="button" id="kt_sign_in_submit" onclick="login()"
