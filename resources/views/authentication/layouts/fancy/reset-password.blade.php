...
<!--begin::Form-->
<form class="form w-100" novalidate="novalidate" id="kt_password_reset_form" data-kt-redirect-url="/metronic8/demo8/../demo8/authentication/layouts/fancy/new-password.html" action="#">
    <!--begin::Heading-->
