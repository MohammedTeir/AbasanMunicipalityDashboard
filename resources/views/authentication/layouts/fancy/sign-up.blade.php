...
<!--begin::Form-->
<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="/metronic8/demo8/../demo8/authentication/layouts/fancy/sign-in.html" action="#">
    <!--begin::Heading-->
