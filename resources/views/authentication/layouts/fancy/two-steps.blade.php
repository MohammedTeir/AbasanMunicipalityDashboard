...
<span class="svg-icon svg-icon-2 svg-icon-gray-800"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<!--end::Svg Icon-->                        </a>   
                ...
                <!--end::Back link-->   
                                    ...
                                    <!--begin::Further link-->
                    <div class="m-0">
                        <span class="text-gray-400 fw-bold fs-5 me-2" data-kt-translate="two-step-head-desc">
                            Didn’t get the code ?
                        </span>

                        <a href="sign-in.html" class="link-primary fw-bold fs-5" data-kt-translate="two-step-head-resend">
                            Resend
                        </a>

                        <span class="text-gray-400 fw-bold fs-5 mx-1" data-kt-translate="two-step-head-or">
                            or 
                        </span>

                        <a href="#" class="link-primary fw-bold fs-5" data-kt-translate="two-step-head-call-us">
                            Call Us
                        </a>  
                    </div>
                    <!--end::Further link--->      
...
<!--begin::Form-->
<form class="form w-100 mb-10" novalidate="novalidate" data-kt-redirect-url="/metronic8/demo8/../demo8/index.html" id="kt_sing_in_two_steps_form">
    <!--begin::Icon-->
    ...
    <div class="text-center mb-10">
        <!--begin::Title-->
        <h1 class="text-dark mb-3" data-kt-translate="two-step-title">
...
<span class="svg-icon svg-icon-3 svg-icon-muted rotate-180 m-0"><svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<!--end::Svg Icon-->                </button>
    ...
    <!--begin::Body-->
    <div class="d-none d-lg-flex flex-lg-row-fluid w-50 bgi-size-cover bgi-position-y-center bgi-position-x-start bgi-no-repeat" style="background-image: url(../../../assets/media/auth/bg11.png)">  
    </div>
    <!--begin::Body-->
</div>
<!--end::Authentication - Two-stes-->	</div>
	<!--end::Root-->
<!--end::Main-->
