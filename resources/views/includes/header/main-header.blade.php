...
<div id="kt_header" style="" class="header  align-items-stretch">
    ...
    <div class="header-brand">
        ...
        <div id="kt_aside_toggle" class="btn btn-icon w-auto px-0 btn-active-color-primary aside-minimize"
            ...
            <span class="svg-icon svg-icon-1 me-n1 minimize-default"><svg width="24" height="24"
            ...
            <span class="svg-icon svg-icon-1 minimize-active"><svg width="24" height="24" viewbox="0 0 24 24"
