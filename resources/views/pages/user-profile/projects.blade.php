...
<!--end::Svg Icon-->                                    <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="60" data-kt-countup-prefix="%">0</div>
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <!--end::Nav item-->
                            <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="projects.html">
                        Projects                    </a>
                </li>
                <!--end::Nav item-->
                            <!--begin::Nav item-->
...
<!--end::Modal - Create Project--><!--begin::Modal - Offer A Deal-->
