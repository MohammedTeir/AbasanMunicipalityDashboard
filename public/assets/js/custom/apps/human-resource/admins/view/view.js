...
var KTAdminsViewMain = function () {
    ...
    // Init sign out single admin
    var initSignOutAdmin = () => {
        const signOutButtons = document.querySelectorAll('[data-kt-admins-sign-out="single_admin"]');
